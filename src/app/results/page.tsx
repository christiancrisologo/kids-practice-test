...
export default function ResultsPage() {
    ...
    const getGradeMessage = (percentage: number) => {
        const funnyQuotes = [
            ...
            "Practice wizard in training! Your powers are growing! 🧙‍♂️📚",
            "Houston, we have a genius! 🚀🌟",
            "You're making numbers dance! 💃🔢",
            "Practice superhero alert! 🦸‍♂️🔥",
            "You're sharper than a pencil! ✏️⚡",
            "Number ninja in action! 🥷🔢",
            "You're solving problems faster than a cheetah! 🐆💨",
            "Practice magician extraordinaire! 🎩✨",
            "You're cooking up some serious skills! 👨‍🍳🔥"
        ];
                                    ...
                                    {isMobile ? (
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="text-xs text-gray-600 dark:text-gray-400">
                                                Your answer: <span className={question.isCorrect ? 'text-green-600 dark:text-green-400 font-semibold' : 'text-red-600 dark:text-red-400 font-semibold'}>{question.userAnswer ?? 'No answer'}</span>
                                            </div>
                                            {!question.isCorrect && (
